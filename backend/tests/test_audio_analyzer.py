...
class TestAudioAnalyzer:
    ...
    async def test_analyze_returns_real_speech_rate(
        ...
        with patch("app.ai.audio_analyzer._librosa.load") as mock_load:
    ...
    async def test_analyze_calculates_volume_consistency(self, audio_analyzer, mock_audio_file):
        ...
        with (
            patch("app.ai.audio_analyzer._librosa.load") as mock_load,
            patch("app.ai.audio_analyzer._librosa.feature.rms") as mock_rms,
        ):
