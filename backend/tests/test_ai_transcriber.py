...
SETTINGS_PATCH = "app.ai.transcriber.settings"
...
class TestTranscribeFile:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_unsupported_format(self, transcriber: Transcriber, tmp_path: Path):
...
class TestEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_transcribe_very_long_audio(self, transcriber: Transcriber, tmp_path: Path):
