...
export default function QuestionCard({ question, onPractice, onPrepare, prepRemaining }: QuestionCardProps) {
  ...
  return (
    <div className="card p-6 hover:border-electric-blue transition-colors">
      ...
      {/* Action Buttons */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between pt-4 border-t border-border-light gap-3 sm:gap-2">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          {onPrepare && (
            <button
              ...
              className={cn(
                'btn-secondary flex items-center justify-center gap-2 py-2 px-3 sm:px-4 flex-1 sm:flex-initial',
          ...
          <button
            ...
            className="btn-primary flex items-center justify-center gap-2 py-2 px-3 sm:px-4 flex-1 sm:flex-initial"
          >
            <Play size={16} />
            <span>Practice</span>
          </button>
