    ...
    <header className="bg-white/90 dark:bg-surface-dark/90 backdrop-blur-xl border-b border-border-light dark:border-white/5 sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14 sm:h-16">
          {/* Timer - Compact */}
          <div className="flex items-center gap-2 sm:gap-3 min-w-[80px] sm:min-w-[120px] md:min-w-[140px]">
          ...
          <div className="flex-1 max-w-[160px] sm:max-w-[200px] md:max-w-xs mx-1 sm:mx-3 md:mx-8">
