...
const steps = [
  {
    ...
    description: 'Practice your interview skills with AI-powered feedback. We\'ll help you become more confident and articulate.',
    highlight: 'Get personalized coaching for your next big interview.',
  },
  {
    icon: Mic,
