              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="relative" ref={userMenuRef}>
                    ...
                    {isUserMenuOpen && (
                      <div className="absolute right-0 mt-2 w-72 max-w-[calc(100vw-1rem)] bg-[hsl(var(--card))] dark:bg-[hsl(var(--card))] rounded-xl shadow-lg border border-[hsl(var(--border))] overflow-hidden animate-scale-in origin-top-right z-50">
                        {/* User Info */}
