          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="experienceLevel" className="block text-sm font-medium text-text-primary mb-2">
                Experience Level <span className="text-text-tertiary font-normal">(optional)</span>
              </label>
              <select
                id="experienceLevel"
              ...
              <p id="experience-hint" className="mt-1 text-xs text-text-tertiary">
                This helps us tailor feedback to your experience level. You can change it anytime in settings.
              </p>
            </div>
