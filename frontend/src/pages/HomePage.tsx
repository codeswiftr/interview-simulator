    ...
    <div className="min-h-screen bg-surface-primary overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-4 sm:mb-6 text-text-primary animate-slide-up">
              Get Your First <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric-blue to-indigo-600">Interview Score</span> in 15 Minutes
            </h1>
            ...
            <p className="text-base sm:text-lg text-text-secondary mb-6 sm:mb-8 lg:mb-10 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: '0.1s' }}>
              Pick a question, record your answer, and get instant feedback. No more guessing if you're ready — know your score before the real interview.
            </p>
            ...
            <p className="text-sm text-text-tertiary mt-4 animate-slide-up" style={{ animationDelay: '0.3s' }}>
              3 free interviews • 7-day free trial when you upgrade
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 relative overflow-hidden bg-charcoal dark:bg-surface-dark-alt">
        ...
        <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-4 sm:mb-6 text-text-inverse">Know Your Score Before the Interview</h2>
          <p className="text-base sm:text-lg mb-6 sm:mb-8 lg:mb-10 text-text-secondary max-w-2xl mx-auto">
            Join 2,500+ engineers who got interview-ready with real, measurable feedback. Start free — no credit card required.
          </p>
